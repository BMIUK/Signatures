...
{ 
	...
	$html = file_get_contents("signature_template.html");

	if($whatsapp == "No") 
		$details = file_get_contents("http://www.bmimedia.net/bmi/signature/templates/3_details.html");
	else
		$details = file_get_contents("http://www.bmimedia.net/bmi/signature/templates/4_details.html");
...
// Save Master
file_put_contents('master.html', $master);